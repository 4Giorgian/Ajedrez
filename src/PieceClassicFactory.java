public class PieceClassicFactory {
    public ChessGamePiece CreateClassicPiece(String pieceName, ChessGameBoard board, int row, int col, int color) {
        ...
        public ChessGamePiece CreateClassicPiece2(String pieceName, ChessGameBoard board, int row, int col, int color) {
