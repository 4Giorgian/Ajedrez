...
public class ChessGameBoard extends JPanel{
    ...
    public void initializeBoard(){
        PieceNormalFactory pieceNormal = new PieceNormalFactory();
        resetBoard( false );
        for ( int i = 0; i < chessCells.length; i++ ){
            for ( int j = 0; j < chessCells[0].length; j++ ){
                ...
                if ( i == 1 ) // black pawns
                {
                    pieceToAdd = pieceNormal.CreateNormalPiece("PAWN", this, i, j, ChessGamePiece.BLACK);
                }
                else if ( i == 6 ) // white pawns
                {
                    pieceToAdd = pieceNormal.CreateNormalPiece("PAWN", this, i, j, ChessGamePiece.WHITE);
                }
                else if ( i == 0 || i == 7 ) // main rows
                {
                    ...
                    if ( j == 0 || j == 7 ){
                        ...
                        pieceToAdd = pieceNormal.CreateNormalPiece("ROOK", this, i, j, colNum);
                    }
                    else if ( j == 1 || j == 6 ){
                        //pieceToAdd = new Knight( this, i, j, colNum );
                        pieceToAdd = pieceNormal.CreateNormalPiece("KNIGHT", this, i, j, colNum);
                    }
                    else if ( j == 2 || j == 5 ){
                        //pieceToAdd = new Bishop( this, i, j, colNum );
                        pieceToAdd = pieceNormal.CreateNormalPiece("BISHOP", this, i, j, colNum);
                    }
                    else if ( j == 3 ){
                        //pieceToAdd = new King( this, i, j, colNum );
                        pieceToAdd = pieceNormal.CreateNormalPiece("KING", this, i, j, colNum);
                    }
                    else
                    {
                       // pieceToAdd = new Queen( this, i, j, colNum );
                        pieceToAdd = pieceNormal.CreateNormalPiece("QUEEN", this, i, j, colNum);
                    }
                }
                else
                {
